      ...
      <div className="w-full max-w-sm">
        <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#8b949e] text-sm mt-1">Create your monitoring account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#484f58] mt-1.5">Minimum 8 characters</p>
            </div>

            <div>
              <label htmlFor="confirmPassword" className="block text-xs font-semibold text-[#8b949e] uppercase tracking-wider mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#484f58]" />
          ...
          <div className="mt-6 text-center">
            <p className="text-[#8b949e] text-sm">
              ...
              <Link to="/login" className="text-[#3498db] hover:text-[#5dade2] font-medium">
                Sign in
              </Link>
            </p>
          </div>
